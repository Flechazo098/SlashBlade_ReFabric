...
public class DriveRenderer<T extends EntityDrive> extends EntityRenderer<T> {
    ...
    private static final ResourceLocation TEXTURE = SlashBladeRefabriced.prefix("model/util/ss.png");
    private static final ResourceLocation MODEL = SlashBladeRefabriced.prefix("model/util/drive.obj");
